...
<div class="layui-layout layui-layout-admin">
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            ...
            <form class="layui-form" action="${pageContext.request.contextPath}/operatorInformationUpdateServlet" style="padding-top: 50px" method="post">
                <div class="layui-form-item">
                    <label class="layui-form-label">工号</label>
                    <div class="layui-input-block">
                        <input type="text" readonly="readonly" name="operator-id" value="${operator.s_id}" required lay-verify="required" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
