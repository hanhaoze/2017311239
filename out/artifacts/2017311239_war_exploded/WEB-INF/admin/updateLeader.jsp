    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            <span class="layui-breadcrumb">
                <a href="">管理员</a>
                <a href="">督导管理</a>
                <a><cite>修改督导信息</cite></a>
            </span>
            <form class="layui-form" action="${pageContext.request.contextPath}/updateLeaderInfoServlet" style="padding-top: 50px" method="post">
                <div class="layui-form-item">
                    <label class="layui-form-label">员工号</label>
                    <div class="layui-input-block">
                        <input type="text" readonly="readonly" name="leader-id" value="${leader.t_id}" autocomplete="off" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-inline">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="leader-postion" id="leader-postion" value="${leader.t_postion}" placeholder="" autocomplete="off" class="layui-input">
                        </div>
                </div>
                <div class="layui-inline">
