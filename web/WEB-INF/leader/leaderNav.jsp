        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="test" id="nav">
                <li class="layui-nav-item">
                    <a class="" href="javascript:;">产线信息</a>
                    <dl class="layui-nav-child">
                        <dd><a href="${pageContext.request.contextPath}/leaderOptionaLineServlet">我的线体</a></dd>
                        <dd hidden id="hidden-score"><a href="#">abc</a></dd>
                        <dd hidden id="hidden-update"><a href="#">abc</a></dd>
                        <dd><a href="${pageContext.request.contextPath}/addSelectLineServlet">添加线体</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a class="" href="javascript:;">操作员通讯录</a>
                    <dl class="layui-nav-child">
                        <dd><a href="${pageContext.request.contextPath}/findOperatorByPageServlet">操作员信息查询</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a class="" href="javascript:;">督导通讯录</a>
                    <dl class="layui-nav-child">
                        <dd><a href="${pageContext.request.contextPath}/leaderListServlet">督导信息查询</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a class="" href="javascript:;">产品信息查询</a>
                    <dl class="layui-nav-child">
