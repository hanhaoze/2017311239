        ...
        <form class="layui-form" id="registerForm" action="${pageContext.request.contextPath}/registerServlet" method="post">
            <div class="layui-input-inline">
                ...
                <div class="layui-inline" style="width: 100%">
                    ...
                    <input type="text" id="user" value="${operatorid}" name="operatorid" required  lay-verify="required" placeholder="请输工号" autocomplete="off" class="layui-input">
                </div>
...
<script type="text/javascript">
    layui.use(['form','jquery','layer'], function () {
        ...
        $('#user').blur(function() {
            ...
            $.get("findOperatorServlet",{operatorid:operatorid},function (data) {
                if (data.operatorExsit) {
