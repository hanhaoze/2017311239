...
<div class="frame-main">
    <div class="login-main">
        <header class="layui-elip">生产线信息管理系统</header>
        <form class="layui-form" action="" name="formf" method="post">

            <div class="layui-input-inline">
                <label class="layadmin-user-login-icon layui-icon layui-icon-username"></label>
                <input type="text" name="id" id="id" value="${loginid}" required lay-verify="required" placeholder="用户名(员工id号)" autocomplete="off"
                       class="layui-input">
            </div>
            <div class="layui-input-inline">
            ...
            <div style="padding-left: 54px;padding-bottom: 6px;">
                <input type="radio" name="roles" value="operator" title="操作员" checked>
                <input type="radio" name="roles" value="leader" title="督导">
...
<script type="text/javascript">
    ...
    function a() {
        ...
        if (id=='' || password=='' || verifycode=='') {
            ...
            if (checked_value=="operator") {
                document.formf.action="${pageContext.request.contextPath}/loginServlet?roles=operator";
                document.formf.submit();

            }else if (checked_value=="leader") {
                document.formf.action="${pageContext.request.contextPath}/loginServlet?roles=leader";
                document.formf.submit();
            }else {
