...
public class FindProductByPageServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        PageBean<ProductInfo> pb =  service.findProductByPage(currentPage,rows,condition);
        ...
        if (operator != null && admin == null && leader == null) {
            request.getRequestDispatcher("/WEB-INF/operator/oFindProductList.jsp").forward(request, response);
            ...
            request.getRequestDispatcher("/WEB-INF/leader/lFindProductList.jsp").forward(request, response);
        } else {
